...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Couchbase.Lite.dll", &exception_gchandle);
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("HockeySDK.iOSBindings.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("GalaSoft.MvvmLight.Platform.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "XamarinNativeTemplate.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
